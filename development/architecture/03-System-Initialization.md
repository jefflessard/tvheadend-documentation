...
sequenceDiagram
    ...
    Main->>MainLoop: Release global lock
    Main->>MainLoop: Signal mtimer thread ready
    Main->>MainLoop: Enter mainloop()
    Note over MainLoop: Process gtimers until shutdown
```
